...
@Component({
  selector: 'app-pluginplay',
  templateUrl: './pluginplay.component.html',
  styleUrls: ['./pluginplay.component.scss']
})
export class PluginplayComponent implements OnInit, AfterViewInit {
  @Input() songs: any;
  ...
  ngAfterViewInit(): void {
    this.musicsv.checkCurrent$.subscribe(data => {
